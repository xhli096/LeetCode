package com.xinghaol.io.json.exception;

/**
 * @author: lixinghao
 * @date: 2020/7/22 10:01 下午
 * @Description:
 */
public class JsonTypeException extends RuntimeException {
     ...
     * @since 1.7
     */
    protected JsonTypeException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
